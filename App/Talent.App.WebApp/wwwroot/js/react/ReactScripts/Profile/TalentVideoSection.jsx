    ...
    render() {
        let uploaders = this.props.videos.map(x =>
            <VideoUpload
                ...
                saveVideoUrl={'https://module1talent-cnfucbdcave3ccgq.australiaeast-01.azurewebsites.net/profile/profile/updateTalentVideo'}   //saveVideoUrl={'http://localhost:60290/profile/profile/updateTalentVideo'}
            />
        )
